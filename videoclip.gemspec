...
Gem::Specification.new do |s|
  ...
  s.files = ["init.rb", "lib/videoclip/video.rb", "lib/videoclip/videos/youtube.rb", "lib/videoclip.rb", "Manifest", "MIT-LICENSE", "Rakefile", "README.rdoc", "tasks/videoclip_tasks.rake", "test/test_helper.rb", "test/videoclip_test.rb", "videoclip.gemspec"]
  s.has_rdoc = true
